...
public class TClassifyTrainByOriginDataSet {
    private static String categoryIds[] = { "100", "200", "300", "400", "500" };
    private static String categoryContent[] = { "二逼导弹", "洲际导弹", "牛逼导弹", "托马斯导弹", "中国导弹" };

    public static void main(String[] args) throws IOException {
        Map<String, String[]> map = new HashMap<String, String[]>(categoryIds.length);
        ...
        for (String categoryId : categoryIds) {
            map.put(categoryId, categoryContent);
        }
